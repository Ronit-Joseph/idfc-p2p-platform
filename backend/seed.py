...
def build_purchase_requests() -> tuple[list[PurchaseRequest], list[PRLineItem]]:
    ...
    prs = [
        PurchaseRequest(
            ...
            requester_email="amit.sharma@p2p.demo",
            amount=12500000,
            currency="INR",
            gl_account="6100",
            cost_center="CC-TECH-01",
        ...
        PurchaseRequest(
            ...
            requester_email="sunita.rao@p2p.demo",
            amount=285000,
            currency="INR",
            gl_account="6600",
            cost_center="CC-ADMIN-01",
        ...
        PurchaseRequest(
            ...
            requester_email="rohan.joshi@p2p.demo",
            amount=8500000,
            currency="INR",
            gl_account="6200",
            cost_center="CC-OPS-01",
        ...
        PurchaseRequest(
            ...
            requester_email="vikram.patel@p2p.demo",
            amount=750000,
            currency="INR",
            gl_account="6400",
            cost_center="CC-MKT-01",
        ...
        PurchaseRequest(
            ...
            requester_email="meera.reddy@p2p.demo",
            amount=3200000,
            currency="INR",
            gl_account="6500",
            cost_center="CC-HR-01",
